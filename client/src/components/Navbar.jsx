...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 py-3 px-3 sm:px-8">
      {/* 
        BUILT-IN AMBIENT GLOW: 
        This absolute glow div forces the intense red atmospheric backlight 
        behind the pill bar on ALL devices and browsers regardless of page background.
      */}
      <div className="max-w-7xl mx-auto relative">
        <div className="absolute -inset-1 bg-gradient-to-r from-[#d80000]/30 via-[#d80000]/60 to-[#d80000]/30 rounded-full blur-xl opacity-80 pointer-events-none"></div>

        {/* Main Navbar Pill */}
        <div className="relative flex items-center justify-between px-4 sm:px-6 py-2.5 rounded-full bg-[#0a0a0a]/85 border border-[#d80000]/50 shadow-[0_0_25px_rgba(216,0,0,0.4)] backdrop-blur-xl [-webkit-backdrop-filter:blur(20px)]">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <button
              type="button"
              onClick={() => handleNavClick('contact', '/contact')}
              className="relative inline-flex items-center justify-center p-0.5 overflow-hidden text-[10px] sm:text-xs font-mono font-bold text-white rounded-full group bg-[#d80000] shadow-[0_0_20px_rgba(216,0,0,0.6)] transition-all duration-300 hover:scale-105"
            >
      ...
      {mobileMenuOpen && (
        <div className="md:hidden mt-2 mx-auto max-w-7xl rounded-2xl bg-[#0a0a0a]/95 border border-[#d80000]/40 backdrop-blur-2xl [-webkit-backdrop-filter:blur(20px)] p-4 flex flex-col gap-4 text-center font-mono font-bold tracking-wider text-sm uppercase shadow-[0_0_20px_rgba(216,0,0,0.3)]">
          <button 
            type="button"
            onClick={() => handleNavClick('home', '/')}
            className={activeTab === 'home' ? activeClass : inactiveClass}
